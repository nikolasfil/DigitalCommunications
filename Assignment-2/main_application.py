...
def main():
    ...
    huffman_encoded_info, huffman_encoded_value = huffman_encode_pairs(combinations_dict)
    ...
    combinations_3_pair_info, combinations_3_pair_dict = get_combinations_different(output,combinations_dict)
    
    huff_encoded_3_pair_info, huff_encoded_3_pair_dict = huffman_encode_pairs(combinations_3_pair_dict,3)

    huff_encoded_3_pair_r_info, huff_encoded_3_pair_r_dict = print_R_info(huff_encoded_3_pair_dict , combinations_3_pair_dict)
    
    huff_encoded_3_h_info = "$$\n H(x) = 3 H(x) = 2 \cdot "+f"{h_value} = {2*h_value} \n$$\n\nH(x) = {2*h_value}\n"

    huff_encoded_3_n_info , huff_encoded_3_n_value= print_n_info(huff_encoded_3_pair_r_dict,h_value,3)
